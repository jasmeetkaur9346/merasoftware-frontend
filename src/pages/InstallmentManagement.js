...
const RegisteredUserTicketSystem = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-100">
      {!isLoggedIn ? (
        ...
        <div className="flex justify-center items-center min-h-screen p-4">
          <div className="bg-white rounded-lg shadow-md w-full max-w-md p-6">
            <div className="text-center mb-8">
              ...
              <p className="text-gray-600">Sign in to access your support tickets</p>
            </div>
            ...
            <form onSubmit={handleLogin}>
              ...
              <button
                type="submit"
                className="w-full bg-blue-600 text-white py-2 px-4 rounded hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 font-medium"
              >
                Sign In
              </button>
            </form>
        ...
        /* Logged In View - Support Dashboard */
...
export default RegisteredUserTicketSystem;