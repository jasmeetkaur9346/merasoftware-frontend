...
const ModernBusinessLandingPage = () => {
  ...
  const content = {
    hinglish: {
      ...
      problemTitle: "Kya aap Business mein in problems se pareshan hain?",
      problems: [
        "Staff ko manage karna mushkil ho raha hai?",
        "Samaan ki chori ka dar hai?",
        "Staff zyada paise le raha hai, naam aapka kharab ho raha hai.",
        ...
        "Kya staff apni zimmedari nahi samajhta?",
        "Kya staff ek doosre par blame dalta hai?"
      ],
    ...
    english: {
      ...
      problems: [
        ...
        "Staff is taking extra money, but your reputation is getting hurt.",
        ...
        "Does the staff not take responsibility?",
        "Do they keep blaming each other?"
      ],
