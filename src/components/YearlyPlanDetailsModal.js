      ...
      <div className="bg-white rounded-xl shadow-2xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
        ...
        <div className="bg-gradient-to-r from-blue-600 to-purple-600 p-6 text-white relative">
          ...
          <div className="flex items-center mb-2">
            ...
            <div>
              <h2 className="text-2xl font-bold">Yearly Plan Details</h2>
              <p className="text-blue-100 text-sm">{plan.productId?.serviceName || 'Website Updates'}</p>
            </div>
          </div>
        </div>
        ...
        <div className="p-6 space-y-6">
            ...
            <div className="space-y-4">
              ...
              <div className="bg-white rounded-lg p-4 shadow-sm">
                <div className="flex justify-between items-center mb-2">
                  <p className="text-sm text-gray-600">Updates Used This Month</p>
                  <div className="flex items-center">
                    <CheckCircle className="w-4 h-4 text-green-600 mr-1" />
                    <span className="font-bold text-green-700">{currentMonthUpdatesUsed}</span>
                  </div>
                </div>
                <div className="flex items-center text-xs text-gray-500">
                  <RefreshCw className="w-3 h-3 mr-1" />
                  <span>Unlimited updates available</span>
                </div>
              </div>
          ...
          <div className="bg-gradient-to-br from-amber-50 to-orange-50 rounded-xl p-5 border border-amber-200">
            ...
            <div className="space-y-2">
              <div className="flex items-start">
                ...
                <p className="text-sm text-gray-700">Unlimited updates every month for 1 year</p>
              </div>
              <div className="flex items-start">
                <CheckCircle className="w-4 h-4 text-green-600 mr-2 mt-0.5 flex-shrink-0" />
                <p className="text-sm text-gray-700">Monthly renewal at ₹{plan.productId?.monthlyRenewalCost || 8000}</p>
              </div>
              <div className="flex items-start">
                <CheckCircle className="w-4 h-4 text-green-600 mr-2 mt-0.5 flex-shrink-0" />
          ...
          <button
            onClick={onClose}
            className="w-full py-3 bg-gradient-to-r from-blue-600 to-purple-600 text-white rounded-lg font-semibold hover:from-blue-700 hover:to-purple-700 transition-all shadow-md hover:shadow-lg"
          >
            Close
          </button>
        </div>
